...
/* themes/contrib/ekam/templates/block/block.html.twig */
class __TwigTemplate_b5a246195c90421de9eae2731747f652 extends Template
{
    private $source;
    private $macros = [];
...
($context["plugin_id"] ?? null), 32, $this->source)))];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 38
            echo "    <h4";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "title"], "method", false, false, true, 38), 38, $this->source), "html", null, true);
            echo ">";
...
";
  ...
  ";
    ...
    {
        return "themes/contrib/ekam/templates/block/block.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/ekam/templates/block/block.html.twig", "/var/www/html/web/themes/contrib/ekam/templates/block/block.html.twig");
    }
